...
Fl_Double_Window* make_help_window() {
  { Help = new Fl_Double_Window(300, 190, "Help");
    { Fl_Button* o = new Fl_Button(105, 152, 70, 20, "Got It!");
    ...
    { new Fl_Output(234, 90, 0, 25, "But don\'t make a mistake");
    } // Fl_Output* o
    { new Fl_Output(245, 117, 0, 25, "or you\'ll be Booed off stage!");
    } // Fl_Output* o
    Help->end();
